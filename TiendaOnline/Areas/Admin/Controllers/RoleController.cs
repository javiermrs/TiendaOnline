...
using TiendaOnline.Areas.Admin.Models;
...
namespace TiendaOnline.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult> Create(string name)
        {
            ...
            if (isExist)
            {
                ViewBag.msg = "Este rol ya existe!";
                ViewBag.name = name;
                return View();
            }
            ...
            if (result.Succeeded)
            {
                TempData["guardar"] = "El rol se agregó correctamente!";
        ...
        public async Task<IActionResult> Edit(string id, string name)
        {
            ...
            if (result.Succeeded)
            {
                TempData["guardar"] = "El rol se actualizó correctamente!";
                return RedirectToAction(nameof(Index));
            }
        ...
        public async Task<IActionResult> DeleteConfirm(string id)
        {
            ...
            if (result.Succeeded)
            {
                TempData["eliminar"] = "El rol se eliminó correctamente!";
                return RedirectToAction(nameof(Index));
            }
        ...
        [HttpPost]
        public async Task<IActionResult> Assign(RoleUsesrVm roleUser)
        {
            ...
            {
                ViewBag.msg = "A este usuario ya se le asignó este rol";
                ViewData["UserID"] = new SelectList(_db.ApplicationUsers.Where(f => f.LockoutEnd < DateTime.Now || f.LockoutEnd == null).ToList(), "Id", "UserName");
                ViewData["RoleID"] = new SelectList(_roleManager.Roles.ToList(), "Name", "Name");
                return View();
            }
            ...
            if (role.Succeeded)
            {
                TempData["guardar"] = "Se asignó el rol al usuario correctamente!";
                return RedirectToAction(nameof(Index));
            }
